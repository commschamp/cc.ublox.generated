/// @file
/// @brief Contains dispatch to handling function(s) for "ublox6" all input messages.

#pragma once

#include <type_traits>
#include "ublox/MsgId.h"
#include "ublox/input/Ublox6Messages.h"
...
/// @note Defined in ublox/dispatch/DispatchUblox6Message.h
...
auto dispatchUblox6MessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6Message<ublox::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchUblox6MessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6Message<ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchUblox6Message.h"
...
struct Ublox6MsgDispatcher
{
    ...
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox6Message<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchUblox6Message<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox6Message<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchUblox6Message<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as @ref Ublox6MsgDispatcher, but passing
///     @ref ublox::options::DefaultOptions as template parameter.
/// @note Defined in "ublox/dispatch/DispatchUblox6Message.h"
using Ublox6MsgDispatcherDefaultOptions =
    Ublox6MsgDispatcher<ublox::options::DefaultOptions>;
