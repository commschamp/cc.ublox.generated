...
/// @file
/// @brief Contains dispatch to handling function(s) for "ublox9" all input messages.

#pragma once

#include <type_traits>
#include "ublox/MsgId.h"
#include "ublox/input/Ublox9Messages.h"
...
/// @note Defined in ublox/dispatch/DispatchUblox9Message.h
...
auto dispatchUblox9MessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox9Message<ublox::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchUblox9MessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox9Message<ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchUblox9Message.h"
...
struct Ublox9MsgDispatcher
{
    ...
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox9Message<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchUblox9Message<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox9Message<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchUblox9Message<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as @ref Ublox9MsgDispatcher, but passing
///     @ref ublox::options::DefaultOptions as template parameter.
/// @note Defined in "ublox/dispatch/DispatchUblox9Message.h"
using Ublox9MsgDispatcherDefaultOptions =
    Ublox9MsgDispatcher<ublox::options::DefaultOptions>;
