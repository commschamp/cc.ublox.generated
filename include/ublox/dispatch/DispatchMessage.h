...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchMessage.h"
...
struct MsgDispatcher
{
    ...
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchMessage<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchMessage<TProtOptions>(id, msg, handler);
    }
...
using MsgDispatcherDefaultOptions =
    MsgDispatcher<ublox::options::DefaultOptions>;
