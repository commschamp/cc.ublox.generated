/// @file
/// @brief Contains dispatch to handling function(s) for "ublox6" client input messages.

#pragma once

#include <type_traits>
#include "ublox/MsgId.h"
#include "ublox/input/Ublox6ClientInputMessages.h"
...
/// @note Defined in ublox/dispatch/DispatchUblox6ClientInputMessage.h
template<typename TProtOptions, typename TMsg, typename THandler>
auto dispatchUblox6ClientInputMessage(
    ublox::MsgId id,
    std::size_t idx,
    TMsg& msg,
...
/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchUblox6ClientInputMessage(), but without @b idx parameter.
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchUblox6ClientInputMessage()
/// @note Defined in ublox/dispatch/DispatchUblox6ClientInputMessage.h
template<typename TProtOptions, typename TMsg, typename THandler>
auto dispatchUblox6ClientInputMessage(
    ublox::MsgId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ClientInputMessage<TProtOptions>(id, 0U, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchUblox6ClientInputMessage(), but passing
...
auto dispatchUblox6ClientInputMessageDefaultOptions(
    ublox::MsgId id,
    std::size_t idx,
    TMsg& msg,
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ClientInputMessage<ublox::options::DefaultOptions>(id, idx, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchUblox6ClientInputMessageDefaultOptions(), 
///     but without @b idx parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchUblox6ClientInputMessageDefaultOptions()
/// @note Defined in ublox/dispatch/DispatchUblox6ClientInputMessage.h
template<typename TMsg, typename THandler>
auto dispatchUblox6ClientInputMessageDefaultOptions(
    ublox::MsgId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ClientInputMessage<ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchUblox6ClientInputMessage.h"
template <typename TProtOptions>
struct Ublox6ClientInputMsgDispatcher
{
    /// @brief Class detection tag
    using MsgDispatcherTag = void;

    /// @brief Dispatch message to its handler.
    /// @details Uses appropriate @ref dispatchUblox6ClientInputMessage() function.
    ...
    /// @return What the @ref dispatchUblox6ClientInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox6ClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchUblox6ClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox6ClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchUblox6ClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as @ref Ublox6ClientInputMsgDispatcher, but passing
///     @ref ublox::options::DefaultOptions as template parameter.
/// @note Defined in "ublox/dispatch/DispatchUblox6ClientInputMessage.h"
using Ublox6ClientInputMsgDispatcherDefaultOptions =
    Ublox6ClientInputMsgDispatcher<ublox::options::DefaultOptions>;
