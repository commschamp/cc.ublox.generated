...
auto dispatchUblox8ServerInputMessage(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox8ServerInputMessage<TProtOptions>(id, 0U, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchUblox8ServerInputMessage.h"
template <typename TProtOptions>
struct Ublox8ServerInputMsgDispatcher
{
    /// @brief Class detection tag
    using MsgDispatcherTag = void;

    /// @brief Dispatch message to its handler.
    /// @details Uses appropriate @ref dispatchUblox8ServerInputMessage() function.
    ...
    /// @return What the @ref dispatchUblox8ServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox8ServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchUblox8ServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox8ServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchUblox8ServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as @ref Ublox8ServerInputMsgDispatcher, but passing
///     @ref ublox::options::DefaultOptions as template parameter.
/// @note Defined in "ublox/dispatch/DispatchUblox8ServerInputMessage.h"
using Ublox8ServerInputMsgDispatcherDefaultOptions =
    Ublox8ServerInputMsgDispatcher<ublox::options::DefaultOptions>;
