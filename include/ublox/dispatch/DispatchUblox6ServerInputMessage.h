/// @file
/// @brief Contains dispatch to handling function(s) for "ublox6" server input messages.

#pragma once

#include <type_traits>
#include "ublox/MsgId.h"
#include "ublox/input/Ublox6ServerInputMessages.h"
...
/// @note Defined in ublox/dispatch/DispatchUblox6ServerInputMessage.h
template<typename TProtOptions, typename TMsg, typename THandler>
auto dispatchUblox6ServerInputMessage(
    ublox::MsgId id,
    std::size_t idx,
    TMsg& msg,
...
/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchUblox6ServerInputMessage(), but without @b idx parameter.
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchUblox6ServerInputMessage()
/// @note Defined in ublox/dispatch/DispatchUblox6ServerInputMessage.h
template<typename TProtOptions, typename TMsg, typename THandler>
auto dispatchUblox6ServerInputMessage(
    ublox::MsgId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ServerInputMessage<TProtOptions>(id, 0U, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchUblox6ServerInputMessage(), but passing
...
auto dispatchUblox6ServerInputMessageDefaultOptions(
    ublox::MsgId id,
    std::size_t idx,
    TMsg& msg,
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ServerInputMessage<ublox::options::DefaultOptions>(id, idx, msg, handler);
}

/// @brief Dispatch message object to its appropriate handling function.
/// @details Same as other dispatchUblox6ServerInputMessageDefaultOptions(), 
///     but without @b idx parameter.
/// @param[in] id Numeric message ID.
/// @param[in] msg Message object held by reference to its interface class.
/// @param[in] handler Reference to handling object.
/// @see dispatchUblox6ServerInputMessageDefaultOptions()
/// @note Defined in ublox/dispatch/DispatchUblox6ServerInputMessage.h
template<typename TMsg, typename THandler>
auto dispatchUblox6ServerInputMessageDefaultOptions(
    ublox::MsgId id,
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ServerInputMessage<ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchUblox6ServerInputMessage.h"
template <typename TProtOptions>
struct Ublox6ServerInputMsgDispatcher
{
    /// @brief Class detection tag
    using MsgDispatcherTag = void;

    /// @brief Dispatch message to its handler.
    /// @details Uses appropriate @ref dispatchUblox6ServerInputMessage() function.
    ...
    /// @return What the @ref dispatchUblox6ServerInputMessage() function returns.
    template <typename TMsg, typename THandler>
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox6ServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchUblox6ServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox6ServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchUblox6ServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as @ref Ublox6ServerInputMsgDispatcher, but passing
///     @ref ublox::options::DefaultOptions as template parameter.
/// @note Defined in "ublox/dispatch/DispatchUblox6ServerInputMessage.h"
using Ublox6ServerInputMsgDispatcherDefaultOptions =
    Ublox6ServerInputMsgDispatcher<ublox::options::DefaultOptions>;
