...
/// @file
/// @brief Contains dispatch to handling function(s) for "ublox9" client input messages.

#pragma once

#include <type_traits>
#include "ublox/MsgId.h"
#include "ublox/input/Ublox9ClientInputMessages.h"
...
/// @note Defined in ublox/dispatch/DispatchUblox9ClientInputMessage.h
...
auto dispatchUblox9ClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox9ClientInputMessage<ublox::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchUblox9ClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox9ClientInputMessage<ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchUblox9ClientInputMessage.h"
...
struct Ublox9ClientInputMsgDispatcher
{
    ...
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox9ClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchUblox9ClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox9ClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchUblox9ClientInputMessage<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as @ref Ublox9ClientInputMsgDispatcher, but passing
///     @ref ublox::options::DefaultOptions as template parameter.
/// @note Defined in "ublox/dispatch/DispatchUblox9ClientInputMessage.h"
using Ublox9ClientInputMsgDispatcherDefaultOptions =
    Ublox9ClientInputMsgDispatcher<ublox::options::DefaultOptions>;
