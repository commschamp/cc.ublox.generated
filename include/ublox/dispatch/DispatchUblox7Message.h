...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchUblox7Message.h"
...
struct Ublox7MsgDispatcher
{
    ...
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox7Message<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchUblox7Message<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox7Message<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchUblox7Message<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as @ref Ublox7MsgDispatcher, but passing
///     @ref ublox::options::DefaultOptions as template parameter.
/// @note Defined in "ublox/dispatch/DispatchUblox7Message.h"
using Ublox7MsgDispatcherDefaultOptions =
    Ublox7MsgDispatcher<ublox::options::DefaultOptions>;
