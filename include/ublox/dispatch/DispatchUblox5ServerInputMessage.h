/// @file
/// @brief Contains dispatch to handling function(s) for "ublox5" server input messages.

#pragma once

#include <type_traits>
#include "ublox/MsgId.h"
#include "ublox/input/Ublox5ServerInputMessages.h"
...
/// @note Defined in ublox/dispatch/DispatchUblox5ServerInputMessage.h
...
auto dispatchUblox5ServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox5ServerInputMessage<ublox::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchUblox5ServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox5ServerInputMessage<ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref ublox::options::DefaultOptions.
/// @headerfile "ublox/dispatch/DispatchUblox5ServerInputMessage.h"
...
struct Ublox5ServerInputMsgDispatcher
{
    ...
    static auto dispatch(ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox5ServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return ublox::dispatch::dispatchUblox5ServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(ublox::dispatch::dispatchUblox5ServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return ublox::dispatch::dispatchUblox5ServerInputMessage<TProtOptions>(id, msg, handler);
    }
...
/// @brief Message dispatcher class to be used with
///     @b comms::processAllWithDispatchViaDispatcher() function (or similar).
/// @details Same as @ref Ublox5ServerInputMsgDispatcher, but passing
///     @ref ublox::options::DefaultOptions as template parameter.
/// @note Defined in "ublox/dispatch/DispatchUblox5ServerInputMessage.h"
using Ublox5ServerInputMsgDispatcherDefaultOptions =
    Ublox5ServerInputMsgDispatcher<ublox::options::DefaultOptions>;
