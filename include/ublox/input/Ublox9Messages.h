...
/// @file
/// @brief Contains definition of all "ublox9" messages bundle.
...
using Ublox9Messages =
    std::tuple<
        ...
        ublox::message::NavRelposned_v1<TBase, TOpt>,
        ublox::message::NavRelposnedPoll<TBase, TOpt>,
        ublox::message::NavSlas<TBase, TOpt>,
        ublox::message::NavSlasPoll<TBase, TOpt>,
        ublox::message::NavSig<TBase, TOpt>,
        ublox::message::NavSigPoll<TBase, TOpt>,
        ...
        ublox::message::CfgValset<TBase, TOpt>,
        ublox::message::CfgValget<TBase, TOpt>,
        ublox::message::CfgValgetPoll<TBase, TOpt>,
        ublox::message::CfgValdel<TBase, TOpt>,
        ...
        ublox::message::MonSpan<TBase, TOpt>,
        ublox::message::MonSpanPoll<TBase, TOpt>,
        ublox::message::MonComms<TBase, TOpt>,
        ublox::message::MonCommsPoll<TBase, TOpt>,
        ublox::message::MonHw3<TBase, TOpt>,
        ublox::message::MonHw3Poll<TBase, TOpt>,
        ublox::message::MonRf<TBase, TOpt>,
        ublox::message::MonRfPoll<TBase, TOpt>,
        ...
        ublox::message::LogRetrievebatch<TBase, TOpt>,
        ublox::message::LogBatch<TBase, TOpt>,
