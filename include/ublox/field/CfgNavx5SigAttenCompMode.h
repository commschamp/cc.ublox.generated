...
public:
    ...
    using SpecialNameInfo = ublox::field::CfgNavx5SigAttenCompModeCommon::SpecialNameInfo;
    
    /// @brief Type returned from @ref specialNamesMap() member function.
    /// @details The @b first value of the pair is pointer to the map array,
    ///     The @b second value of the pair is the size of the array.
    using SpecialNamesMapInfo = ublox::field::CfgNavx5SigAttenCompModeCommon::SpecialNamesMapInfo;
    
    /// @brief Compile time detection of special values presence.
    static constexpr bool hasSpecials()
    {
        return ublox::field::CfgNavx5SigAttenCompModeCommon::hasSpecials();
    }
    
    /// @brief Special value <b>"Disabled"</b>.
    /// @see @ref ublox::field::CfgNavx5SigAttenCompModeCommon::valueDisabled().
    ...
    /// @see @ref ublox::field::CfgNavx5SigAttenCompModeCommon::valueAutomatic().
    ...
    {
        return ublox::field::CfgNavx5SigAttenCompModeCommon::specialNamesMap();
    }
