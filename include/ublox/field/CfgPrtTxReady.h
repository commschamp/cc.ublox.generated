...
struct CfgPrtTxReadyMembers
{
    ...
    public:
        ...
        /// @see @ref ublox::field::CfgPrtTxReadyMembersCommon::BitsCommon::bitName().
...
public:
    ...
    ///         for ublox::field::CfgPrtTxReadyMembers::Bits member field.
    ///     @li @b FieldIdx_pin index, @b Field_pin type and @b field_pin() access function -
    ///         for ublox::field::CfgPrtTxReadyMembers::Pin member field.
    ///     @li @b FieldIdx_thres index, @b Field_thres type and @b field_thres() access function -
    ///         for ublox::field::CfgPrtTxReadyMembers::Thres member field.
