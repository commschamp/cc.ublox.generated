...
struct MsgIdCommon
{
    ...
    static const char* valueName(ublox::MsgId val)
    {
        ...
        auto iter = std::lower_bound(
            begIter, endIter, val,
            [](const ValueNameInfo& info, ublox::MsgId v) -> bool
            {
                return info.first < v;
            });
    ...
    static ValueNamesMapInfo valueNamesMap()
    {
        static const ValueNameInfo Map[] = {
            ...
            std::make_pair(ublox::MsgId_NavSlas, "NAV-SLAS"),
            std::make_pair(ublox::MsgId_NavSig, "NAV-SIG"),
            ...
            std::make_pair(ublox::MsgId_CfgValset, "CFG-VALSET"),
            std::make_pair(ublox::MsgId_CfgValget, "CFG-VALGET"),
            std::make_pair(ublox::MsgId_CfgValdel, "CFG-VALDEL"),
            ...
            std::make_pair(ublox::MsgId_MonSpan, "MON-SPAN"),
            std::make_pair(ublox::MsgId_MonComms, "MON-COMMS"),
            std::make_pair(ublox::MsgId_MonHw3, "MON-HW3"),
            std::make_pair(ublox::MsgId_MonRf, "MON-RF"),
            ...
            std::make_pair(ublox::MsgId_LogRetrievebatch, "LOG-RETRIEVEBATCH"),
            std::make_pair(ublox::MsgId_LogBatch, "LOG-BATCH"),
