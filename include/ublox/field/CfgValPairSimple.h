...
public:
    ...
    ///         for ublox::field::CfgValPairSimpleMembers::Key member field.
    ///     @li @b FieldIdx_val index, @b Field_val type and @b field_val() access function -
    ///         for ublox::field::CfgValPairSimpleMembers::Val member field.
