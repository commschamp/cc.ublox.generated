...
#include "ublox/message/MonMsgppCommon.h"
...
struct MonMsgppFields
{
        ...
        >
    {
        ...
        {
            return ublox::message::MonMsgppFieldsCommon::Msg1Common::name();
        }
        ...
        >
    {
        ...
        static const char* name()
        {
            return ublox::message::MonMsgppFieldsCommon::Msg2Common::name();
        }
        ...
        >
    {
        ...
        static const char* name()
        {
            return ublox::message::MonMsgppFieldsCommon::Msg3Common::name();
        }
        ...
        >
    {
        ...
        static const char* name()
        {
            return ublox::message::MonMsgppFieldsCommon::Msg4Common::name();
        }
        ...
        >
    {
        ...
        static const char* name()
        {
            return ublox::message::MonMsgppFieldsCommon::Msg5Common::name();
        }
        ...
        >
    {
        ...
        static const char* name()
        {
            return ublox::message::MonMsgppFieldsCommon::Msg6Common::name();
        }
    ...
    struct SkippedMembers
    {
            ...
            >
        {
            ...
            static const char* name()
            {
                return ublox::message::MonMsgppFieldsCommon::SkippedMembersCommon::ElementCommon::name();
            }
        ...
        >
    {
        ...
        static const char* name()
        {
            return ublox::message::MonMsgppFieldsCommon::SkippedCommon::name();
        }
...
public:
    ...
    ///     @li @b Field_msg1 type and @b field_msg1() access fuction
    ///         for @ref MonMsgppFields::Msg1 field.
    ///     @li @b Field_msg2 type and @b field_msg2() access fuction
    ///         for @ref MonMsgppFields::Msg2 field.
    ///     @li @b Field_msg3 type and @b field_msg3() access fuction
    ///         for @ref MonMsgppFields::Msg3 field.
    ///     @li @b Field_msg4 type and @b field_msg4() access fuction
    ///         for @ref MonMsgppFields::Msg4 field.
    ///     @li @b Field_msg5 type and @b field_msg5() access fuction
    ///         for @ref MonMsgppFields::Msg5 field.
    ///     @li @b Field_msg6 type and @b field_msg6() access fuction
    ///         for @ref MonMsgppFields::Msg6 field.
    ///     @li @b Field_skipped type and @b field_skipped() access fuction
    ...
    {
        return ublox::message::MonMsgppCommon::name();
    }
