...
struct LogFindtimeRespFields
{
    ...
    public:
        ...
        {
            return ublox::message::LogFindtimeRespFieldsCommon::VersionCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::LogFindtimeRespFieldsCommon::TypeCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::LogFindtimeRespFieldsCommon::EntryNumberCommon::hasSpecials();
        }
