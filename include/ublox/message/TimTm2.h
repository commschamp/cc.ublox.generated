...
struct TimTm2Fields
{
    ...
    public:
        ...
        ///     @li @b Field_timeBase type and @b field_timeBase() access function -
...
public:
    ...
    ///     @li @b Field_ch type and @b field_ch() access fuction
    ///         for @ref TimTm2Fields::Ch field.
    ///     @li @b Field_flags type and @b field_flags() access fuction
    ///         for @ref TimTm2Fields::Flags field.
    ///     @li @b Field_count type and @b field_count() access fuction
    ///         for @ref TimTm2Fields::Count field.
    ///     @li @b Field_wnR type and @b field_wnR() access fuction
    ///         for @ref TimTm2Fields::WnR field.
    ///     @li @b Field_wnF type and @b field_wnF() access fuction
    ///         for @ref TimTm2Fields::WnF field.
    ///     @li @b Field_towMsR type and @b field_towMsR() access fuction
    ///         for @ref TimTm2Fields::TowMsR field.
    ///     @li @b Field_towSubMsR type and @b field_towSubMsR() access fuction
    ///         for @ref TimTm2Fields::TowSubMsR field.
    ///     @li @b Field_towMsF type and @b field_towMsF() access fuction
    ///         for @ref TimTm2Fields::TowMsF field.
    ///     @li @b Field_towSubMsF type and @b field_towSubMsF() access fuction
    ///         for @ref TimTm2Fields::TowSubMsF field.
    ///     @li @b Field_accEst type and @b field_accEst() access fuction
