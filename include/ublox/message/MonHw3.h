...
struct MonHw3Fields
{
    ...
    struct ListMembers
    {
        ...
        public:
            ...
            ///     @li @b FieldIdx_pinIdindex, @b Field_pinIdtype and @b field_pinId() access function -
            ///         for ElementMembers::PinId member field.
            ///     @li @b FieldIdx_pinMaskindex, @b Field_pinMasktype and @b field_pinMask() access function -
            ///         for ElementMembers::PinMask member field.
            ///     @li @b FieldIdx_vPindex, @b Field_vPtype and @b field_vP() access function -
