...
struct AidAopFields
{
    ...
    public:
        ...
        {
            return ublox::message::AidAopFieldsCommon::SvidCommon::hasSpecials();
        }
    ...
    struct OptionalsMembers
    {
        ...
        public:
            ...
            ///         for ublox::message::AidAopFields::OptionalsMembers::OptionalsWrapMembers::Optional0 member field.
            ///     @li @b FieldIdx_optional1 index, @b Field_optional1 type and @b field_optional1() access function -
            ///         for ublox::message::AidAopFields::OptionalsMembers::OptionalsWrapMembers::Optional1 member field.
            ///     @li @b FieldIdx_optional2 index, @b Field_optional2 type and @b field_optional2() access function -
            ///         for ublox::message::AidAopFields::OptionalsMembers::OptionalsWrapMembers::Optional2 member field.
