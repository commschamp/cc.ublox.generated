...
#include "ublox/message/MgaDbdCommon.h"
...
struct MgaDbdFields
{
    ...
    struct Reserved1Members
    {
            ...
            >
        {
            ...
            {
                return ublox::message::MgaDbdFieldsCommon::Reserved1MembersCommon::ElementCommon::name();
            }
        ...
        >
    {
        ...
        static const char* name()
        {
            return ublox::message::MgaDbdFieldsCommon::Reserved1Common::name();
        }
        ...
        >
    {
        ...
        static const char* name()
        {
            return ublox::message::MgaDbdFieldsCommon::DataCommon::name();
        }
...
public:
    ...
    {
        return ublox::message::MgaDbdCommon::name();
    }
