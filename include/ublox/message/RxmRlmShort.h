...
struct RxmRlmShortFields
{
    ...
    public:
        ...
        {
            return ublox::message::RxmRlmShortFieldsCommon::VersionCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::RxmRlmShortFieldsCommon::TypeCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::RxmRlmShortFieldsCommon::SvidCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::RxmRlmShortFieldsCommon::MessageCommon::hasSpecials();
        }
