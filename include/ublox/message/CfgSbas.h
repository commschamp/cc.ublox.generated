...
public:
    ...
    ///     @li @b Field_maxSBAS type and @b field_maxSBAS() access fuction
    ///         for @ref CfgSbasFields::MaxSBAS field.
    ///     @li @b Field_scanmode2 type and @b field_scanmode2() access fuction
    ///         for @ref CfgSbasFields::Scanmode2 field.
    ///     @li @b Field_scanmode1 type and @b field_scanmode1() access fuction
