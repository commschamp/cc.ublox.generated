...
#include "ublox/message/CfgSbasCommon.h"
...
struct CfgSbasFields
{
    ...
    public:
        ...
        /// @see @ref ublox::message::CfgSbasFieldsCommon::ModeCommon::bitName().
        ...
        {
            return ublox::message::CfgSbasFieldsCommon::ModeCommon::name();
        }
    };
    ...
    public:
        ...
        /// @brief Retrieve name of the bit.
        /// @see @ref ublox::message::CfgSbasFieldsCommon::UsageCommon::bitName().
        static const char* bitName(BitIdx idx)
        {
            return
        ...
        static const char* name()
        {
            return ublox::message::CfgSbasFieldsCommon::UsageCommon::name();
        }
    };
    ...
    public:
        ...
        {
            return ublox::message::CfgSbasFieldsCommon::MaxSBASCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::CfgSbasFieldsCommon::MaxSBASCommon::name();
        }
    };
    ...
    public:
        ...
        /// @brief Retrieve name of the bit.
        /// @see @ref ublox::message::CfgSbasFieldsCommon::Scanmode2Common::bitName().
        static const char* bitName(BitIdx idx)
        {
            return
        ...
        static const char* name()
        {
            return ublox::message::CfgSbasFieldsCommon::Scanmode2Common::name();
        }
    };
    ...
    public:
        ...
        /// @brief Retrieve name of the bit.
        /// @see @ref ublox::message::CfgSbasFieldsCommon::Scanmode1Common::bitName().
        static const char* bitName(BitIdx idx)
        {
            return
        ...
        static const char* name()
        {
            return ublox::message::CfgSbasFieldsCommon::Scanmode1Common::name();
        }
    };
...
public:
    ...
    {
        return ublox::message::CfgSbasCommon::name();
    }
};
