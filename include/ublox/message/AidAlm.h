...
#include "ublox/message/AidAlmCommon.h"
...
struct AidAlmFields
{
    ...
    public:
        ...
        {
            return ublox::message::AidAlmFieldsCommon::SvidCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::AidAlmFieldsCommon::SvidCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::AidAlmFieldsCommon::WeekCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::AidAlmFieldsCommon::WeekCommon::name();
        }
    };
    ...
    struct DwrdMembers
    {
        ...
        struct ListMembers
        {
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return ublox::message::AidAlmFieldsCommon::DwrdMembersCommon::ListMembersCommon::ElementCommon::hasSpecials();
                }

                /// @brief Name of the field.
                static const char* name()
                {
                    return ublox::message::AidAlmFieldsCommon::DwrdMembersCommon::ListMembersCommon::ElementCommon::name();
                }
            };
        };
        ...
        public:
            ...
            static const char* name()
            {
                return ublox::message::AidAlmFieldsCommon::DwrdMembersCommon::ListCommon::name();
            }
        };
    };
    ...
    public:
        ...
        static const char* name()
        {
            return ublox::message::AidAlmFieldsCommon::DwrdCommon::name();
        }
    };
...
public:
    ...
    {
        return ublox::message::AidAlmCommon::name();
    }
