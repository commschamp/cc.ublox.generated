...
public:
    ...
    ///     @li @b Field_vendorId type and @b field_vendorId() access fuction
    ///         for @ref CfgUsbFields::VendorId field.
    ///     @li @b Field_productId type and @b field_productId() access fuction
    ...
    ///     @li @b Field_powerConsumption type and @b field_powerConsumption() access fuction
    ...
    ///     @li @b Field_vendorString type and @b field_vendorString() access fuction
    ///         for @ref CfgUsbFields::VendorString field.
    ///     @li @b Field_productString type and @b field_productString() access fuction
    ///         for @ref CfgUsbFields::ProductString field.
    ///     @li @b Field_serialNumber type and @b field_serialNumber() access fuction
