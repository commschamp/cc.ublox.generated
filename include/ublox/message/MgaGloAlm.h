...
public:
    ...
    ///     @li @b Field_c type and @b field_c() access fuction
    ///         for @ref MgaGloAlmFields::C field.
    ///     @li @b Field_tau type and @b field_tau() access fuction
    ///         for @ref MgaGloAlmFields::Tau field.
    ///     @li @b Field_epsilon type and @b field_epsilon() access fuction
    ///         for @ref MgaGloAlmFields::Epsilon field.
    ///     @li @b Field_lambda type and @b field_lambda() access fuction
    ...
    ///     @li @b Field_tLambda type and @b field_tLambda() access fuction
    ///         for @ref MgaGloAlmFields::TLambda field.
    ///     @li @b Field_deltaT type and @b field_deltaT() access fuction
    ///         for @ref MgaGloAlmFields::DeltaT field.
    ///     @li @b Field_deltaDT type and @b field_deltaDT() access fuction
