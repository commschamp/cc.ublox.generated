...
public:
    ...
    ///     @li @b Field_satH1 type and @b field_satH1() access fuction
    ...
    ///     @li @b Field_a2 type and @b field_a2() access fuction
    ...
    ///     @li @b Field_tGD1 type and @b field_tGD1() access fuction
    ///         for @ref MgaBdsEphFields::TGD1 field.
    ///     @li @b Field_uRAI type and @b field_uRAI() access fuction
    ///         for @ref MgaBdsEphFields::URAI field.
    ///     @li @b Field_iODE type and @b field_iODE() access fuction
