...
#include "ublox/message/MonRxrCommon.h"
...
struct MonRxrFields
{
    ...
    public:
        ...
        /// @see @ref ublox::message::MonRxrFieldsCommon::FlagsCommon::bitName().
        ...
        {
            return ublox::message::MonRxrFieldsCommon::FlagsCommon::name();
        }
    };
...
public:
    ...
    {
        return ublox::message::MonRxrCommon::name();
    }
};
