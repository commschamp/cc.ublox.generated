...
public:
    ...
    ///     @li @b Field_srcId type and @b field_srcId() access fuction
    ...
    ///     @li @b Field_raw0 type and @b field_raw0() access fuction
    ///         for @ref TimVcocalExtFields::Raw0 field.
    ///     @li @b Field_raw1 type and @b field_raw1() access fuction
    ///         for @ref TimVcocalExtFields::Raw1 field.
    ///     @li @b Field_maxStepSize type and @b field_maxStepSize() access fuction
