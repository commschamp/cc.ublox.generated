...
struct NavSolFields
{
    ...
    public:
        ...
        {
            return ublox::message::NavSolFieldsCommon::WeekCommon::hasSpecials();
        }
    ...
    public:
        ...
        /// @see @ref ublox::message::NavSolFieldsCommon::FlagsCommon::bitName().
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::NavSolFieldsCommon::NumSVCommon::hasSpecials();
        }
