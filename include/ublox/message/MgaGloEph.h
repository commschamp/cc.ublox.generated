...
public:
    ...
    ///     @li @b Field_fT type and @b field_fT() access fuction
    ///         for @ref MgaGloEphFields::FT field.
    ///     @li @b Field_b type and @b field_b() access fuction
    ///         for @ref MgaGloEphFields::B field.
    ///     @li @b Field_m type and @b field_m() access fuction
    ///         for @ref MgaGloEphFields::M field.
    ///     @li @b Field_h type and @b field_h() access fuction
    ///         for @ref MgaGloEphFields::H field.
    ///     @li @b Field_x type and @b field_x() access fuction
    ///         for @ref MgaGloEphFields::X field.
    ///     @li @b Field_y type and @b field_y() access fuction
    ///         for @ref MgaGloEphFields::Y field.
    ///     @li @b Field_z type and @b field_z() access fuction
    ...
    ///     @li @b Field_ddx type and @b field_ddx() access fuction
    ///         for @ref MgaGloEphFields::Ddx field.
    ///     @li @b Field_ddy type and @b field_ddy() access fuction
    ///         for @ref MgaGloEphFields::Ddy field.
    ///     @li @b Field_ddz type and @b field_ddz() access fuction
    ///         for @ref MgaGloEphFields::Ddz field.
    ///     @li @b Field_tb type and @b field_tb() access fuction
    ///         for @ref MgaGloEphFields::Tb field.
    ///     @li @b Field_gamma type and @b field_gamma() access fuction
    ///         for @ref MgaGloEphFields::Gamma field.
    ///     @li @b Field_e type and @b field_e() access fuction
    ///         for @ref MgaGloEphFields::E field.
    ///     @li @b Field_deltaTau type and @b field_deltaTau() access fuction
    ///         for @ref MgaGloEphFields::DeltaTau field.
    ///     @li @b Field_tau type and @b field_tau() access fuction
