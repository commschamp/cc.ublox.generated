...
struct CfgGnssFields
{
    ...
    struct ListMembers
    {
        ...
        public:
            ...
            ///     @li @b FieldIdx_resTrkChindex, @b Field_resTrkChtype and @b field_resTrkCh() access function -
            ///         for ElementMembers::ResTrkCh member field.
            ///     @li @b FieldIdx_maxTrkChindex, @b Field_maxTrkChtype and @b field_maxTrkCh() access function -
