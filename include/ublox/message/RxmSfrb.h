...
#include "ublox/message/RxmSfrbCommon.h"
...
struct RxmSfrbFields
{
    ...
    public:
        ...
        {
            return ublox::message::RxmSfrbFieldsCommon::CnoCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::RxmSfrbFieldsCommon::CnoCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::RxmSfrbFieldsCommon::SvidCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::RxmSfrbFieldsCommon::SvidCommon::name();
        }
    };
    ...
    struct DwrdMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return ublox::message::RxmSfrbFieldsCommon::DwrdMembersCommon::ElementCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return ublox::message::RxmSfrbFieldsCommon::DwrdMembersCommon::ElementCommon::name();
            }
        };
    };
    ...
    public:
        ...
        static const char* name()
        {
            return ublox::message::RxmSfrbFieldsCommon::DwrdCommon::name();
        }
    };
...
public:
    ...
    {
        return ublox::message::RxmSfrbCommon::name();
    }
};
