...
struct RxmRlmLongFields
{
    ...
    public:
        ...
        {
            return ublox::message::RxmRlmLongFieldsCommon::VersionCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::RxmRlmLongFieldsCommon::TypeCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::RxmRlmLongFieldsCommon::SvidCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::RxmRlmLongFieldsCommon::MessageCommon::hasSpecials();
        }
