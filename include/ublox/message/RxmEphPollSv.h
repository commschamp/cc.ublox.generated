...
#include "ublox/message/RxmEphPollSvCommon.h"
...
struct RxmEphPollSvFields
{
    ...
    public:
        ...
        {
            return ublox::message::RxmEphPollSvFieldsCommon::SvidCommon::hasSpecials();
        }
        
        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::RxmEphPollSvFieldsCommon::SvidCommon::name();
        }
...
public:
    ...
    {
        return ublox::message::RxmEphPollSvCommon::name();
    }
