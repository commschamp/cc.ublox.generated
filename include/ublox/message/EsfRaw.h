...
struct EsfRawFields
{
    ...
    struct DataMembers
    {
        ...
        public:
            ...
            ///     @li @b FieldIdx_dataFieldindex, @b Field_dataFieldtype and @b field_dataField() access function -
            ///         for ElementMembers::DataField member field.
            ///     @li @b FieldIdx_dataTypeindex, @b Field_dataTypetype and @b field_dataType() access function -
            ///         for ElementMembers::DataType member field.
            ///     @li @b FieldIdx_sTtagindex, @b Field_sTtagtype and @b field_sTtag() access function -
