...
public:
    ...
    ///     @li @b Field_disableEkf type and @b field_disableEkf() access fuction
    ///         for @ref CfgEkfFields::DisableEkf field.
    ///     @li @b Field_actionFlags type and @b field_actionFlags() access fuction
    ///         for @ref CfgEkfFields::ActionFlags field.
    ///     @li @b Field_configFlags type and @b field_configFlags() access fuction
    ///         for @ref CfgEkfFields::ConfigFlags field.
    ///     @li @b Field_inverseFlags type and @b field_inverseFlags() access fuction
    ...
    ///     @li @b Field_nomPPDist type and @b field_nomPPDist() access fuction
    ///         for @ref CfgEkfFields::NomPPDist field.
    ///     @li @b Field_nomZero type and @b field_nomZero() access fuction
    ///         for @ref CfgEkfFields::NomZero field.
    ///     @li @b Field_nomSens type and @b field_nomSens() access fuction
    ///         for @ref CfgEkfFields::NomSens field.
    ///     @li @b Field_rmsTemp type and @b field_rmsTemp() access fuction
    ///         for @ref CfgEkfFields::RmsTemp field.
    ///     @li @b Field_tempUpdate type and @b field_tempUpdate() access fuction
