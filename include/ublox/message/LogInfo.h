...
public:
    ...
    ///     @li @b Field_filestoreCapacity type and @b field_filestoreCapacity() access fuction
    ...
    ///     @li @b Field_currentMaxLogSize type and @b field_currentMaxLogSize() access fuction
    ///         for @ref LogInfoFields::CurrentMaxLogSize field.
    ///     @li @b Field_currentLogSize type and @b field_currentLogSize() access fuction
    ...
    ///     @li @b Field_oldestYear type and @b field_oldestYear() access fuction
    ///         for @ref LogInfoFields::OldestYear field.
    ///     @li @b Field_oldestMonth type and @b field_oldestMonth() access fuction
    ///         for @ref LogInfoFields::OldestMonth field.
    ///     @li @b Field_oldestDay type and @b field_oldestDay() access fuction
    ///         for @ref LogInfoFields::OldestDay field.
    ///     @li @b Field_oldestHour type and @b field_oldestHour() access fuction
    ///         for @ref LogInfoFields::OldestHour field.
    ///     @li @b Field_oldestMinute type and @b field_oldestMinute() access fuction
    ///         for @ref LogInfoFields::OldestMinute field.
    ///     @li @b Field_oldestSecond type and @b field_oldestSecond() access fuction
    ...
    ///     @li @b Field_newestYear type and @b field_newestYear() access fuction
    ///         for @ref LogInfoFields::NewestYear field.
    ///     @li @b Field_newestMonth type and @b field_newestMonth() access fuction
    ///         for @ref LogInfoFields::NewestMonth field.
    ///     @li @b Field_newestDay type and @b field_newestDay() access fuction
    ///         for @ref LogInfoFields::NewestDay field.
    ///     @li @b Field_newestHour type and @b field_newestHour() access fuction
    ///         for @ref LogInfoFields::NewestHour field.
    ///     @li @b Field_newestMinute type and @b field_newestMinute() access fuction
    ///         for @ref LogInfoFields::NewestMinute field.
    ///     @li @b Field_newestSecond type and @b field_newestSecond() access fuction
