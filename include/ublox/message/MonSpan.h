...
struct MonSpanFields
{
    ...
    public:
        ...
        {
            return ublox::message::MonSpanFieldsCommon::VersionCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MonSpanFieldsCommon::NumRfblocksCommon::hasSpecials();
        }
    ...
    struct ListMembers
    {
        ...
        struct ElementMembers
        {
            ...
            struct SpectrumMembers
            {
                ...
                public:
                    ...
                    static constexpr bool hasSpecials()
                    {
                        return ublox::message::MonSpanFieldsCommon::ListMembersCommon::ElementMembersCommon::SpectrumMembersCommon::ElementCommon::hasSpecials();
                    }
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return ublox::message::MonSpanFieldsCommon::ListMembersCommon::ElementMembersCommon::SpanCommon::hasSpecials();
                }
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return ublox::message::MonSpanFieldsCommon::ListMembersCommon::ElementMembersCommon::ResCommon::hasSpecials();
                }
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return ublox::message::MonSpanFieldsCommon::ListMembersCommon::ElementMembersCommon::CenterCommon::hasSpecials();
                }
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return ublox::message::MonSpanFieldsCommon::ListMembersCommon::ElementMembersCommon::PgaCommon::hasSpecials();
                }
        ...
        public:
            ...
            ///         for ublox::message::MonSpanFields::ListMembers::ElementMembers::Spectrum member field.
            ///     @li @b FieldIdx_span index, @b Field_span type and @b field_span() access function -
            ///         for ublox::message::MonSpanFields::ListMembers::ElementMembers::Span member field.
            ///     @li @b FieldIdx_res index, @b Field_res type and @b field_res() access function -
            ///         for ublox::message::MonSpanFields::ListMembers::ElementMembers::Res member field.
            ///     @li @b FieldIdx_center index, @b Field_center type and @b field_center() access function -
            ///         for ublox::message::MonSpanFields::ListMembers::ElementMembers::Center member field.
            ///     @li @b FieldIdx_pga index, @b Field_pga type and @b field_pga() access function -
            ///         for ublox::message::MonSpanFields::ListMembers::ElementMembers::Pga member field.
            ///     @li @b FieldIdx_reserved1 index, @b Field_reserved1 type and @b field_reserved1() access function -
            ///         for ublox::message::MonSpanFields::ListMembers::ElementMembers::Reserved1 member field.
...
private:
    ...
    bool refresh_list()
    {
        ...
        do {
            ...
            field_numRfblocks().value() = static_cast<PrefixValueType>(maxAllowedValue);
            updated = true;
        } while (false);
