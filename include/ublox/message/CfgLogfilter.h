...
public:
    ...
    ///     @li @b Field_minInterval type and @b field_minInterval() access fuction
    ///         for @ref CfgLogfilterFields::MinInterval field.
    ///     @li @b Field_timeThreshold type and @b field_timeThreshold() access fuction
    ///         for @ref CfgLogfilterFields::TimeThreshold field.
    ///     @li @b Field_speedThreshold type and @b field_speedThreshold() access fuction
    ///         for @ref CfgLogfilterFields::SpeedThreshold field.
    ///     @li @b Field_positionThres type and @b field_positionThres() access fuction
