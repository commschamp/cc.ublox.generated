...
#include "ublox/message/RxmPmreqV0Common.h"
...
struct RxmPmreqV0Fields
{
    ...
    public:
        ...
        {
            return ublox::message::RxmPmreqV0FieldsCommon::VersionCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::RxmPmreqV0FieldsCommon::VersionCommon::name();
        }
    ...
    public:
        ...
        static const char* name()
        {
            return ublox::message::RxmPmreqV0FieldsCommon::Reserved1Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::RxmPmreqV0FieldsCommon::DurationCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::RxmPmreqV0FieldsCommon::DurationCommon::name();
        }
    };
    ...
    public:
        ...
        /// @see @ref ublox::message::RxmPmreqV0FieldsCommon::FlagsCommon::bitName().
        ...
        static const char* name()
        {
            return ublox::message::RxmPmreqV0FieldsCommon::FlagsCommon::name();
        }
    };
    ...
    public:
        ...
        /// @brief Retrieve name of the bit.
        /// @see @ref ublox::message::RxmPmreqV0FieldsCommon::WakeupSourcesCommon::bitName().
        static const char* bitName(BitIdx idx)
        {
            return
        ...
        static const char* name()
        {
            return ublox::message::RxmPmreqV0FieldsCommon::WakeupSourcesCommon::name();
        }
    };
...
public:
    ...
    {
        return ublox::message::RxmPmreqV0Common::name();
    }
};
