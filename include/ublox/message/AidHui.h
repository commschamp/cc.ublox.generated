...
public:
    ...
    ///     @li @b Field_health type and @b field_health() access fuction
    ///         for @ref AidHuiFields::Health field.
    ///     @li @b Field_utcA0 type and @b field_utcA0() access fuction
    ///         for @ref AidHuiFields::UtcA0 field.
    ///     @li @b Field_utcA1 type and @b field_utcA1() access fuction
    ///         for @ref AidHuiFields::UtcA1 field.
    ///     @li @b Field_utcTOW type and @b field_utcTOW() access fuction
    ///         for @ref AidHuiFields::UtcTOW field.
    ///     @li @b Field_utcWNT type and @b field_utcWNT() access fuction
    ///         for @ref AidHuiFields::UtcWNT field.
    ///     @li @b Field_utcLS type and @b field_utcLS() access fuction
    ///         for @ref AidHuiFields::UtcLS field.
    ///     @li @b Field_utcWNF type and @b field_utcWNF() access fuction
    ///         for @ref AidHuiFields::UtcWNF field.
    ///     @li @b Field_utcDN type and @b field_utcDN() access fuction
    ///         for @ref AidHuiFields::UtcDN field.
    ///     @li @b Field_utcLSF type and @b field_utcLSF() access fuction
    ///         for @ref AidHuiFields::UtcLSF field.
    ///     @li @b Field_utcSpare type and @b field_utcSpare() access fuction
    ///         for @ref AidHuiFields::UtcSpare field.
    ///     @li @b Field_klobA0 type and @b field_klobA0() access fuction
    ///         for @ref AidHuiFields::KlobA0 field.
    ///     @li @b Field_klobA1 type and @b field_klobA1() access fuction
    ///         for @ref AidHuiFields::KlobA1 field.
    ///     @li @b Field_klobA2 type and @b field_klobA2() access fuction
    ///         for @ref AidHuiFields::KlobA2 field.
    ///     @li @b Field_klobA3 type and @b field_klobA3() access fuction
    ///         for @ref AidHuiFields::KlobA3 field.
    ///     @li @b Field_klobB0 type and @b field_klobB0() access fuction
    ///         for @ref AidHuiFields::KlobB0 field.
    ///     @li @b Field_klobB1 type and @b field_klobB1() access fuction
    ///         for @ref AidHuiFields::KlobB1 field.
    ///     @li @b Field_klobB2 type and @b field_klobB2() access fuction
    ///         for @ref AidHuiFields::KlobB2 field.
    ///     @li @b Field_klobB3 type and @b field_klobB3() access fuction
