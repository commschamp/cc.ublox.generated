...
struct AidIniFields
{
    ...
    struct DateMembers
    {
        ...
        public:
            ...
            ///     @li @b Field_yeartype and @b field_year() access function -
            ///         for DateBundleMembers::Year member field.
            ///     @li @b Field_monthtype and @b field_month() access function -
    ...
    struct TimeMembers
    {
        ...
        public:
            ...
            ///
            ///     The generated access types and functions functions are:
            ///     @li @b Field_daytype and @b field_day() access function -
            ///         for TimeBundleMembers::Day member field.
            ///     @li @b Field_hourtype and @b field_hour() access function -
            ///         for TimeBundleMembers::Hour member field.
            ///     @li @b Field_mintype and @b field_min() access function -
            ///         for TimeBundleMembers::Min member field.
            ///     @li @b Field_sectype and @b field_sec() access function -
...
public:
    ...
    ///     @li @b Field_posAcc type and @b field_posAcc() access fuction
    ///         for @ref AidIniFields::PosAcc field.
    ///     @li @b Field_tmCfg type and @b field_tmCfg() access fuction
    ///         for @ref AidIniFields::TmCfg field.
    ///     @li @b Field_wno type and @b field_wno() access fuction
    ///         for @ref AidIniFields::Wno field.
    ///     @li @b Field_date type and @b field_date() access fuction
    ///         for @ref AidIniFields::Date field.
    ///     @li @b Field_tow type and @b field_tow() access fuction
    ///         for @ref AidIniFields::Tow field.
    ///     @li @b Field_time type and @b field_time() access fuction
    ///         for @ref AidIniFields::Time field.
    ///     @li @b Field_towNs type and @b field_towNs() access fuction
    ///         for @ref AidIniFields::TowNs field.
    ///     @li @b Field_tAccMs type and @b field_tAccMs() access fuction
    ...
    ///     @li @b Field_freqAcc type and @b field_freqAcc() access fuction
