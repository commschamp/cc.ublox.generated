...
struct LogRetrieveposextraFields
{
    ...
    public:
        ...
        {
            return ublox::message::LogRetrieveposextraFieldsCommon::EntryIndexCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::LogRetrieveposextraFieldsCommon::VersionCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::LogRetrieveposextraFieldsCommon::DistanceCommon::hasSpecials();
        }
