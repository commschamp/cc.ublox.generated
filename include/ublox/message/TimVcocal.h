...
public:
    ...
    ///     @li @b Field_oscId type and @b field_oscId() access fuction
    ...
    ///     @li @b Field_gainUncertainty type and @b field_gainUncertainty() access fuction
    ///         for @ref TimVcocalFields::GainUncertainty field.
    ///     @li @b Field_gainVco type and @b field_gainVco() access fuction
