...
struct LogRetrieveFields
{
    ...
    public:
        ...
        {
            return ublox::message::LogRetrieveFieldsCommon::StartNumberCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::LogRetrieveFieldsCommon::EntryCountCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::LogRetrieveFieldsCommon::VersionCommon::hasSpecials();
        }
