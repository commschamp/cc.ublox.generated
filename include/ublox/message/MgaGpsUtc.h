...
#include "ublox/message/MgaGpsUtcCommon.h"
...
struct MgaGpsUtcFields
{
    ...
    public:
        ...
        {
            return ublox::message::MgaGpsUtcFieldsCommon::TypeCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::TypeCommon::name();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::VersionCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::VersionCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::Reserved1Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcA0Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcA0Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcA1Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcA1Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcDtLSCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcDtLSCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcTotCommon::hasSpecials();
        }
        ...
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcTotCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcWNtCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcWNtCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcWNlsfCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcWNlsfCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcDnCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcDnCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcDtLSFCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::UtcDtLSFCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return ublox::message::MgaGpsUtcFieldsCommon::Reserved2Common::name();
        }
    };
...
public:
    ...
    {
        return ublox::message::MgaGpsUtcCommon::name();
    }
};
