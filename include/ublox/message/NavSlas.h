...
struct NavSlasFields
{
    ...
    public:
        ...
        {
            return ublox::message::NavSlasFieldsCommon::VersionCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::NavSlasFieldsCommon::GmsLonCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::NavSlasFieldsCommon::GmsLatCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::NavSlasFieldsCommon::GmsCodeCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::NavSlasFieldsCommon::QzssSvIdCommon::hasSpecials();
        }
    ...
    public:
        ...
        /// @see @ref ublox::message::NavSlasFieldsCommon::ServiceFlagsCommon::bitName().
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::NavSlasFieldsCommon::CntCommon::hasSpecials();
        }
    ...
    struct ListMembers
    {
        ...
        struct ElementMembers
        {
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return ublox::message::NavSlasFieldsCommon::ListMembersCommon::ElementMembersCommon::SvidCommon::hasSpecials();
                }
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return ublox::message::NavSlasFieldsCommon::ListMembersCommon::ElementMembersCommon::SigIdCommon::hasSpecials();
                }
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return ublox::message::NavSlasFieldsCommon::ListMembersCommon::ElementMembersCommon::PrcCommon::hasSpecials();
                }
        ...
        public:
            ...
            ///         for ublox::message::NavSlasFields::ListMembers::ElementMembers::GnssId member field.
            ///     @li @b FieldIdx_svid index, @b Field_svid type and @b field_svid() access function -
            ///         for ublox::message::NavSlasFields::ListMembers::ElementMembers::Svid member field.
            ///     @li @b FieldIdx_sigId index, @b Field_sigId type and @b field_sigId() access function -
            ///         for ublox::message::NavSlasFields::ListMembers::ElementMembers::SigId member field.
            ///     @li @b FieldIdx_reserved1 index, @b Field_reserved1 type and @b field_reserved1() access function -
            ///         for ublox::message::NavSlasFields::ListMembers::ElementMembers::Reserved1 member field.
            ///     @li @b FieldIdx_prc index, @b Field_prc type and @b field_prc() access function -
            ///         for ublox::message::NavSlasFields::ListMembers::ElementMembers::Prc member field.
...
private:
    ...
    bool refresh_list()
    {
        ...
        do {
            ...
            field_cnt().value() = static_cast<PrefixValueType>(maxAllowedValue);
            updated = true;
        } while (false);
