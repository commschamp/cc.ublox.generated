...
public:
    ...
    ///     @li @b Field_ionoAlpha0 type and @b field_ionoAlpha0() access fuction
    ///         for @ref MgaGpsIonoFields::IonoAlpha0 field.
    ///     @li @b Field_ionoAlpha1 type and @b field_ionoAlpha1() access fuction
    ///         for @ref MgaGpsIonoFields::IonoAlpha1 field.
    ///     @li @b Field_ionoAlpha2 type and @b field_ionoAlpha2() access fuction
    ///         for @ref MgaGpsIonoFields::IonoAlpha2 field.
    ///     @li @b Field_ionoAlpha3 type and @b field_ionoAlpha3() access fuction
    ///         for @ref MgaGpsIonoFields::IonoAlpha3 field.
    ///     @li @b Field_ionoBeta0 type and @b field_ionoBeta0() access fuction
    ///         for @ref MgaGpsIonoFields::IonoBeta0 field.
    ///     @li @b Field_ionoBeta1 type and @b field_ionoBeta1() access fuction
    ///         for @ref MgaGpsIonoFields::IonoBeta1 field.
    ///     @li @b Field_ionoBeta2 type and @b field_ionoBeta2() access fuction
    ///         for @ref MgaGpsIonoFields::IonoBeta2 field.
    ///     @li @b Field_ionoBeta3 type and @b field_ionoBeta3() access fuction
