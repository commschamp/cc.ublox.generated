...
struct NavStatusFields
{
    ...
    public:
        ...
        /// @see @ref ublox::message::NavStatusFieldsCommon::FlagsCommon::bitName().
    ...
    struct FixStatMembers
    {
        ...
        public:
            ...
            /// @brief Retrieve name of the bit.
            /// @see @ref ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::BitsCommon::bitName().
            static const char* bitName(BitIdx idx)
            {
                return
        ...
        /// @see @ref ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::MapMatchingCommon::ValueType
        class MapMatching : public
            comms::field::EnumValue<
                ublox::field::FieldBase<>,
                ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::MapMatchingCommon::ValueType,
        ...
        public:
            ...
            using ValueNameInfo = ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::MapMatchingCommon::ValueNameInfo;

            /// @brief Type returned from @ref valueNamesMap() member function.
            /// @see @ref ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::MapMatchingCommon::ValueNamesMapInfo.
            using ValueNamesMapInfo = ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::MapMatchingCommon::ValueNamesMapInfo;

            /// @brief Retrieve name of the enum value.
            /// @see @ref ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::MapMatchingCommon::valueName().
            ...
            /// @see @ref ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::MapMatchingCommon::valueNamesMap().
            static ValueNamesMapInfo valueNamesMap()
            {
                return ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::MapMatchingCommon::valueNamesMap();
            }
    ...
    public:
        ...
        ///         for ublox::message::NavStatusFields::FixStatMembers::Bits member field.
        ///     @li @b FieldIdx_mapMatching index, @b Field_mapMatching type and @b field_mapMatching() access function -
        ///         for ublox::message::NavStatusFields::FixStatMembers::MapMatching member field.
    ...
    struct Flags2Members
    {
        ...
        /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::PsmStateCommon::ValueType
        class PsmState : public
            comms::field::EnumValue<
                ublox::field::FieldBase<>,
                ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::PsmStateCommon::ValueType,
                comms::option::def::FixedBitLength<2U>,
                comms::option::def::ValidNumValueRange<0, 3>
            >
        {
        ...
        public:
            ...
            /// @brief Single value name info entry.
            using ValueNameInfo = ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::PsmStateCommon::ValueNameInfo;

            /// @brief Type returned from @ref valueNamesMap() member function.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::PsmStateCommon::ValueNamesMapInfo.
            using ValueNamesMapInfo = ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::PsmStateCommon::ValueNamesMapInfo;

            /// @brief Retrieve name of the enum value.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::PsmStateCommon::valueName().
            static const char* valueName(ValueType val)
            {
            ...
            /// @brief Retrieve map of enum value names.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::PsmStateCommon::valueNamesMap().
            static ValueNamesMapInfo valueNamesMap()
            {
                return ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::PsmStateCommon::valueNamesMap();
            }
        ...
        public:
            ...
            {
                return ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::Res1Common::hasSpecials();
            }
        ...
        /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::SpoofDetStateCommon::ValueType
        class SpoofDetState : public
            comms::field::EnumValue<
                ublox::field::FieldBase<>,
                ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::SpoofDetStateCommon::ValueType,
                comms::option::def::FixedBitLength<2U>,
                comms::option::def::ValidNumValueRange<0, 3>
            >
        {
        ...
        public:
            ...
            /// @brief Single value name info entry.
            using ValueNameInfo = ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::SpoofDetStateCommon::ValueNameInfo;

            /// @brief Type returned from @ref valueNamesMap() member function.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::SpoofDetStateCommon::ValueNamesMapInfo.
            using ValueNamesMapInfo = ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::SpoofDetStateCommon::ValueNamesMapInfo;

            /// @brief Retrieve name of the enum value.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::SpoofDetStateCommon::valueName().
            static const char* valueName(ValueType val)
            {
            ...
            /// @brief Retrieve map of enum value names.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::SpoofDetStateCommon::valueNamesMap().
            static ValueNamesMapInfo valueNamesMap()
            {
                return ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::SpoofDetStateCommon::valueNamesMap();
            }
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::Res2Common::hasSpecials();
            }
        ...
        /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::CarrSolnCommon::ValueType
        class CarrSoln : public
            comms::field::EnumValue<
                ublox::field::FieldBase<>,
                ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::CarrSolnCommon::ValueType,
                comms::option::def::FixedBitLength<2U>,
        ...
        public:
            ...
            /// @brief Single value name info entry.
            using ValueNameInfo = ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::CarrSolnCommon::ValueNameInfo;

            /// @brief Type returned from @ref valueNamesMap() member function.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::CarrSolnCommon::ValueNamesMapInfo.
            using ValueNamesMapInfo = ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::CarrSolnCommon::ValueNamesMapInfo;

            /// @brief Retrieve name of the enum value.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::CarrSolnCommon::valueName().
            static const char* valueName(ValueType val)
            {
            ...
            /// @brief Retrieve map of enum value names.
            /// @see @ref ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::CarrSolnCommon::valueNamesMap().
            static ValueNamesMapInfo valueNamesMap()
            {
                return ublox::message::NavStatusFieldsCommon::Flags2MembersCommon::CarrSolnCommon::valueNamesMap();
            }
    ...
    public:
        ...
        ///         for ublox::message::NavStatusFields::Flags2Members::PsmState member field.
        ///     @li @b FieldIdx_res1 index, @b Field_res1 type and @b field_res1() access function -
        ///         for ublox::message::NavStatusFields::Flags2Members::Res1 member field.
        ///     @li @b FieldIdx_spoofDetState index, @b Field_spoofDetState type and @b field_spoofDetState() access function -
        ///         for ublox::message::NavStatusFields::Flags2Members::SpoofDetState member field.
        ///     @li @b FieldIdx_res2 index, @b Field_res2 type and @b field_res2() access function -
        ///         for ublox::message::NavStatusFields::Flags2Members::Res2 member field.
        ///     @li @b FieldIdx_carrSoln index, @b Field_carrSoln type and @b field_carrSoln() access function -
        ///         for ublox::message::NavStatusFields::Flags2Members::CarrSoln member field.
        COMMS_FIELD_MEMBERS_NAMES(
            psmState,
            res1,
            spoofDetState,
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::NavStatusFieldsCommon::TtffCommon::hasSpecials();
        }
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return ublox::message::NavStatusFieldsCommon::MsssCommon::hasSpecials();
        }
