...
public:
    ...
    ///     @li @b Field_bitfield0 type and @b field_bitfield0() access fuction
    ...
    ///     @li @b Field_xAngRate type and @b field_xAngRate() access fuction
    ///         for @ref EsfInsFields::XAngRate field.
    ///     @li @b Field_yAngRate type and @b field_yAngRate() access fuction
    ///         for @ref EsfInsFields::YAngRate field.
    ///     @li @b Field_zAngRate type and @b field_zAngRate() access fuction
    ///         for @ref EsfInsFields::ZAngRate field.
    ///     @li @b Field_xAccel type and @b field_xAccel() access fuction
    ///         for @ref EsfInsFields::XAccel field.
    ///     @li @b Field_yAccel type and @b field_yAccel() access fuction
    ///         for @ref EsfInsFields::YAccel field.
    ///     @li @b Field_zAccel type and @b field_zAccel() access fuction
