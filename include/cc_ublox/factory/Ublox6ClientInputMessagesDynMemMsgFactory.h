...
#include <memory>
#include "cc_ublox/input/Ublox6ClientInputMessages.h"
...
/// @brief Message factory with dynamic memory allocation for the client input "ublox6" platform specific messages.
...
class Ublox6ClientInputMessagesDynMemMsgFactory
{
public:
