...
public:
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (static_cast<std::intmax_t>(id))
        {
            ...
            case 560 /* 0x230 */: return 2;
            case 561 /* 0x231 */: return 2;
            ...
            case 2864 /* 0xb30 */: return 2;
            case 2865 /* 0xb31 */: return 2;
            case 2866 /* 0xb32 */: return 1;
