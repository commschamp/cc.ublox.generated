...
/// @brief Message factory with dynamic memory allocation for all the "ublox8" platform specific messages.
...
class Ublox8MessagesDynMemMsgFactory
{
public:
    ...
    std::size_t msgCount(MsgIdParamType id) const
    {
        switch (static_cast<std::intmax_t>(id))
        {
            ...
            case 316 /* 0x13c */: return 2U;
            case 352 /* 0x160 */: return 2U;
