...
/// @brief Message factory with dynamic memory allocation for the server input "ublox5" platform specific messages.
...
class Ublox5ServerInputMessagesDynMemMsgFactory
{
public:
