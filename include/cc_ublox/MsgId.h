...
enum MsgId : std::uint16_t
{
    ...
    MsgId_NavSlas = 0x0142U, ///< message id of <b>NAV-SLAS</b> message. 
    MsgId_NavSig = 0x0143U, ///< message id of <b>NAV-SIG</b> message. 
    ...
    MsgId_CfgValset = 0x068AU, ///< message id of <b>CFG-VALSET</b> message. 
    MsgId_CfgValget = 0x068BU, ///< message id of <b>CFG-VALGET</b> message. 
    MsgId_CfgValdel = 0x068CU, ///< message id of <b>CFG-VALDEL</b> message. 
    ...
    MsgId_MonSpan = 0x0A31U, ///< message id of <b>MON-SPAN</b> message. 
    MsgId_MonComms = 0x0A36U, ///< message id of <b>MON-COMMS</b> message. 
    MsgId_MonHw3 = 0x0A37U, ///< message id of <b>MON-HW3</b> message. 
    MsgId_MonRf = 0x0A38U, ///< message id of <b>MON-RF</b> message. 
    ...
    MsgId_LogRetrievebatch = 0x2110U, ///< message id of <b>LOG-RETRIEVEBATCH</b> message. 
    MsgId_LogBatch = 0x2111U, ///< message id of <b>LOG-BATCH</b> message. 
