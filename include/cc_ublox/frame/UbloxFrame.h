...
{
    /// @brief Scope for field(s) of @ref Payload layer.
    struct PayloadMembers
    {
        /// @brief Custom field for @ref cc_ublox::frame::UbloxFrameLayers::Payload layer
        class Field : public
            comms::field::ArrayList<
                cc_ublox::field::FieldBase<>,
                std::uint8_t,
                typename TOpt::frame::UbloxFrameLayers::PayloadMembers::Field,
    ...
    using Payload =
        comms::frame::MsgDataLayer<
            comms::option::def::FieldType<typename PayloadMembers::Field>
        >;
