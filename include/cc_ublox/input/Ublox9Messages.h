...
/// @brief All ublox9 platform messages of the protocol in ascending order.
...
/// @brief Create type aliases for the all ublox9 platform messages of the protocol.
/// @param prefix_ Prefix of the alias message type.
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
/// @param opts_ Type of the used protocol definition options.
#define CC_UBLOX_ALIASES_FOR_UBLOX9_MESSAGES(prefix_, suffix_, interface_, opts_) \
...
/// @brief Create type aliases for the all ublox9 platform messages of the protocol using default options.
/// @param prefix_ Prefix of the alias message type.
/// @param suffix_ Suffix of the alias message type.
/// @param interface_ Type of the common message interface.
#define CC_UBLOX_ALIASES_FOR_UBLOX9_MESSAGES_DEFAULT_OPTIONS(prefix_, suffix_, interface_) \
    CC_UBLOX_ALIASES_FOR_UBLOX9_MESSAGES(prefix_, suffix_, interface_, cc_ublox::options::DefaultOptions)
