...
#include "cc_ublox/factory/AllMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_ublox::factory::AllMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_ublox::factory::AllMessagesDynMemMsgFactory<TInterface, AllMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
