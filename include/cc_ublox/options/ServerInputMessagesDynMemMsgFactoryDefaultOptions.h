...
#include "cc_ublox/factory/ServerInputMessagesDynMemMsgFactory.h"
...
{
    /// @brief Alias to @ref cc_ublox::factory::ServerInputMessagesDynMemMsgFactory message factory.
    ...
    using MsgFactory = cc_ublox::factory::ServerInputMessagesDynMemMsgFactory<TInterface, ServerInputMessagesDynMemMsgFactoryDefaultOptionsT<TBase> >;
