...
/// @note Defined in cc_ublox/dispatch/DispatchServerInputMessage.h
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<cc_ublox::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchServerInputMessage<cc_ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_ublox::options::DefaultOptions.
/// @headerfile cc_ublox/dispatch/DispatchServerInputMessage.h
...
struct ServerInputMsgDispatcher
{
    ...
    static auto dispatch(cc_ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_ublox::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_ublox::dispatch::dispatchServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_ublox::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_ublox::dispatch::dispatchServerInputMessage<TProtOptions>(id, msg, handler);
    }
