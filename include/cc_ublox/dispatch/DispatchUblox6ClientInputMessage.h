...
/// @note Defined in cc_ublox/dispatch/DispatchUblox6ClientInputMessage.h
...
auto dispatchUblox6ClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ClientInputMessage<cc_ublox::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchUblox6ClientInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ClientInputMessage<cc_ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_ublox::options::DefaultOptions.
/// @headerfile cc_ublox/dispatch/DispatchUblox6ClientInputMessage.h
...
struct Ublox6ClientInputMsgDispatcher
{
    ...
    static auto dispatch(cc_ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_ublox::dispatch::dispatchUblox6ClientInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_ublox::dispatch::dispatchUblox6ClientInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_ublox::dispatch::dispatchUblox6ClientInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_ublox::dispatch::dispatchUblox6ClientInputMessage<TProtOptions>(id, msg, handler);
    }
