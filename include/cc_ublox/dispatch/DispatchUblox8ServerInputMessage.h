...
/// @note Defined in cc_ublox/dispatch/DispatchUblox8ServerInputMessage.h
...
auto dispatchUblox8ServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox8ServerInputMessage<cc_ublox::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchUblox8ServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox8ServerInputMessage<cc_ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_ublox::options::DefaultOptions.
/// @headerfile cc_ublox/dispatch/DispatchUblox8ServerInputMessage.h
...
struct Ublox8ServerInputMsgDispatcher
{
    ...
    static auto dispatch(cc_ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_ublox::dispatch::dispatchUblox8ServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_ublox::dispatch::dispatchUblox8ServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_ublox::dispatch::dispatchUblox8ServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_ublox::dispatch::dispatchUblox8ServerInputMessage<TProtOptions>(id, msg, handler);
    }
