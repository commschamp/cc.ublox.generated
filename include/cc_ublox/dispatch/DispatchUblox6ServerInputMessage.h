...
/// @note Defined in cc_ublox/dispatch/DispatchUblox6ServerInputMessage.h
...
auto dispatchUblox6ServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ServerInputMessage<cc_ublox::options::DefaultOptions>(id, idx, msg, handler);
}
...
auto dispatchUblox6ServerInputMessageDefaultOptions(
    ...
    THandler& handler) -> decltype(handler.handle(msg))
{
    return dispatchUblox6ServerInputMessage<cc_ublox::options::DefaultOptions>(id, msg, handler);
}
...
/// @tparam TProtOptions Protocol options struct used for the application,
///     like @ref cc_ublox::options::DefaultOptions.
/// @headerfile cc_ublox/dispatch/DispatchUblox6ServerInputMessage.h
...
struct Ublox6ServerInputMsgDispatcher
{
    ...
    static auto dispatch(cc_ublox::MsgId id, std::size_t idx, TMsg& msg, THandler& handler) ->
        decltype(cc_ublox::dispatch::dispatchUblox6ServerInputMessage<TProtOptions>(id, idx, msg, handler))
    {
        return cc_ublox::dispatch::dispatchUblox6ServerInputMessage<TProtOptions>(id, idx, msg, handler);
    }
    ...
    static auto dispatch(cc_ublox::MsgId id, TMsg& msg, THandler& handler) ->
        decltype(cc_ublox::dispatch::dispatchUblox6ServerInputMessage<TProtOptions>(id, msg, handler))
    {
        return cc_ublox::dispatch::dispatchUblox6ServerInputMessage<TProtOptions>(id, msg, handler);
    }
