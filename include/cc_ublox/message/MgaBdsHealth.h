...
#include "cc_ublox/message/MgaBdsHealthCommon.h"
...
/// @headerfile cc_ublox/message/MgaBdsHealth.h
...
struct MgaBdsHealthFields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::MgaBdsHealthFieldsCommon::TypeCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::MgaBdsHealthFieldsCommon::TypeCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsHealthFieldsCommon::VersionCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::MgaBdsHealthFieldsCommon::VersionCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsHealthFieldsCommon::Reserved1Common::name();
        }
    };
    ...
    struct HealthCodeMembers
    {
        ...
        public:
            ...
            static constexpr bool hasSpecials()
            {
                return cc_ublox::message::MgaBdsHealthFieldsCommon::HealthCodeMembersCommon::ElementCommon::hasSpecials();
            }

            /// @brief Name of the field.
            static const char* name()
            {
                return cc_ublox::message::MgaBdsHealthFieldsCommon::HealthCodeMembersCommon::ElementCommon::name();
            }
        };
    };
    ...
    class HealthCode : public
        comms::field::ArrayList<
            ...
            comms::option::def::HasName,
            comms::option::def::SequenceFixedSize<30>
        >
    {
        using Base =
            comms::field::ArrayList<
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsHealthFieldsCommon::HealthCodeCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsHealthFieldsCommon::Reserved2Common::name();
        }
    };
...
public:
    ...
    {
        return cc_ublox::message::MgaBdsHealthCommon::name();
    }
};
