...
struct MonHw3Fields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::MonHw3FieldsCommon::FlagsCommon::bitName(idx);
        }
    ...
    class Reserved0 : public
        comms::field::ArrayList<
            ...
            comms::option::def::HasName,
            comms::option::def::SequenceFixedSize<9>
        >
    {
        using Base =
            comms::field::ArrayList<
        ...
        struct ElementMembers
        {
            ...
            struct PinMaskMembers
            {
                ...
                public:
                    ...
                    static const char* bitName(std::size_t idx)
                    {
                        return cc_ublox::message::MonHw3FieldsCommon::ListMembersCommon::ElementMembersCommon::PinMaskMembersCommon::BitsLowCommon::bitName(idx);
                    }
                ...
                class BitsHigh : public
                    comms::field::BitmaskValue<
                        ...
                        comms::option::def::BitmaskReservedBits<0xFC0, 0x0>
                    >
                {
                    using Base =
                        comms::field::BitmaskValue<
                ...
                public:
                    ...
                    static const char* bitName(std::size_t idx)
                    {
                        return cc_ublox::message::MonHw3FieldsCommon::ListMembersCommon::ElementMembersCommon::PinMaskMembersCommon::BitsHighCommon::bitName(idx);
                    }
...
class MonHw3 : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<2615 /* 0xa37 */>,
