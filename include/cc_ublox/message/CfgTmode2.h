...
struct CfgTmode2Fields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::CfgTmode2FieldsCommon::FlagsCommon::bitName(idx);
        }
...
class CfgTmode2 : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<1597 /* 0x63d */>,
...
public:
    ...
    static_assert(MsgMinLen == 19, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 43, "Unexpected max serialisation length");
