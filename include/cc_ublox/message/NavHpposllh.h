...
struct NavHpposllhFields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::NavHpposllhFieldsCommon::FlagsCommon::bitName(idx);
        }
    ...
    class LonHp : public
        comms::field::IntValue<
            ...
            std::int8_t,
            comms::option::def::HasName,
            comms::option::def::ScalingRatio<1, 100000000>,
...
class NavHpposllh : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<276 /* 0x114 */>,
