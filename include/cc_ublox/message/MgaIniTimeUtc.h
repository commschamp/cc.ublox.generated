    ...
    struct RefMembers
    {
        ...
        class Bits : public
            comms::field::BitmaskValue<
                ...
                comms::option::def::HasName,
                comms::option::def::FixedBitLength<4>,
                comms::option::def::BitmaskReservedBits<0xC, 0x0>
            >
        {
            using Base =
                comms::field::BitmaskValue<
        ...
        public:
            ...
            {
                return cc_ublox::message::MgaIniTimeUtcFieldsCommon::RefMembersCommon::BitsCommon::bitName(idx);
            }
...
class MgaIniTimeUtc : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<4928 /* 0x1340 */>,
