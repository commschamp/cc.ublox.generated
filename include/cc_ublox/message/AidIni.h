...
struct AidIniFields
{
    ...
    class TmCfg : public
        comms::field::BitmaskValue<
            ...
            comms::option::def::BitmaskReservedBits<0xFFAD, 0x0>
        >
    {
        using Base =
            comms::field::BitmaskValue<
    ...
    public:
        ...
        {
            return cc_ublox::message::AidIniFieldsCommon::TmCfgCommon::bitName(idx);
        }
    ...
    class Flags : public
        comms::field::BitmaskValue<
            ...
            comms::option::def::BitmaskReservedBits<0xFFFFFB00U, 0x0>
        >
    {
        using Base =
            comms::field::BitmaskValue<
    ...
    public:
        ...
        static const char* bitName(std::size_t idx)
        {
            return cc_ublox::message::AidIniFieldsCommon::FlagsCommon::bitName(idx);
        }
...
class AidIni : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<2817 /* 0xb01 */>,
...
public:
    ...
    static_assert(MsgMaxLen == 74, "Unexpected max serialisation length");
