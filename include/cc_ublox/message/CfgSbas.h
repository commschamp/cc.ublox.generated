...
struct CfgSbasFields
{
    ...
    public:
        ...
        {
            return
                cc_ublox::message::CfgSbasFieldsCommon::ModeCommon::bitName(
    ...
    public:
        ...
        {
            return
                cc_ublox::message::CfgSbasFieldsCommon::UsageCommon::bitName(
                    static_cast<std::size_t>(idx));
        }
    ...
    public:
        ...
        {
            return
                cc_ublox::message::CfgSbasFieldsCommon::Scanmode2Common::bitName(
                    static_cast<std::size_t>(idx));
        }
    ...
    public:
        ...
        {
            return
                cc_ublox::message::CfgSbasFieldsCommon::Scanmode1Common::bitName(
                    static_cast<std::size_t>(idx));
        }
