...
struct HnrPvtFields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::HnrPvtFieldsCommon::ValidCommon::bitName(idx);
        }
    ...
    public:
        ...
        static const char* bitName(std::size_t idx)
        {
            return cc_ublox::message::HnrPvtFieldsCommon::FlagsCommon::bitName(idx);
        }
...
class HnrPvt : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<10240 /* 0x2800 */>,
