...
#include <tuple>
#include "cc_ublox/message/MonRxbufPollCommon.h"
...
/// @headerfile cc_ublox/message/MonRxbufPoll.h
...
class MonRxbufPoll : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<2567 /* 0xa07 */>,
...
public:
    ...
    {
        return cc_ublox::message::MonRxbufPollCommon::name();
    }
};
