...
struct TimTpFields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return cc_ublox::message::TimTpFieldsCommon::FlagsMembersCommon::BitsLowCommon::bitName(idx);
            }
        ...
        public:
            ...
            static const char* bitName(std::size_t idx)
            {
                return cc_ublox::message::TimTpFieldsCommon::FlagsMembersCommon::BitsHighCommon::bitName(idx);
            }
...
class TimTp : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<3329 /* 0xd01 */>,
