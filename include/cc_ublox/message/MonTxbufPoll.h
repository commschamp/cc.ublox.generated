...
#include <tuple>
#include "cc_ublox/message/MonTxbufPollCommon.h"
...
/// @headerfile cc_ublox/message/MonTxbufPoll.h
...
class MonTxbufPoll : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<2568 /* 0xa08 */>,
...
public:
    ...
    {
        return cc_ublox::message::MonTxbufPollCommon::name();
    }
};
