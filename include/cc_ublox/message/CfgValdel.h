...
struct CfgValdelFields
{
    ...
    class Layers : public
        comms::field::BitmaskValue<
            ...
            comms::option::def::BitmaskReservedBits<0xF9, 0x0>
        >
    {
        using Base =
            comms::field::BitmaskValue<
    ...
    public:
        ...
        {
            return cc_ublox::message::CfgValdelFieldsCommon::LayersCommon::bitName(idx);
        }
...
class CfgValdel : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<1676 /* 0x68c */>,
