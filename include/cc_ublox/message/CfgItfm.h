    ...
    struct ConfigMembers
    {
        ...
        class AlgorithmBits : public
            comms::field::IntValue<
                ...
                comms::option::def::DefaultNumValue<1487190>,
                comms::option::def::ValidNumValue<1487190>
            >
        {
            using Base =
                comms::field::IntValue<
        ...
        public:
            ...
            {
                return cc_ublox::message::CfgItfmFieldsCommon::ConfigMembersCommon::BitsCommon::bitName(idx);
            }
    ...
    struct Config2Members
    {
        ...
        class BitsHigh : public
            comms::field::BitmaskValue<
                ...
                comms::option::def::BitmaskReservedBits<0x3FFFEU, 0x0>
            >
        {
            using Base =
                comms::field::BitmaskValue<
        ...
        public:
            ...
            static const char* bitName(std::size_t idx)
            {
                return cc_ublox::message::CfgItfmFieldsCommon::Config2MembersCommon::BitsHighCommon::bitName(idx);
            }
...
class CfgItfm : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<1593 /* 0x639 */>,
