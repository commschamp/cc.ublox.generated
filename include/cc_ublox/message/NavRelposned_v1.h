    ...
    struct FlagsMembers
    {
        ...
        class BitsHigh : public
            comms::field::BitmaskValue<
                ...
                comms::option::def::BitmaskReservedBits<0x7FFFFF0U, 0x0>
            >
        {
            using Base =
                comms::field::BitmaskValue<
...
public:
    ...
    static_assert(MsgMinLen == 64, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 64, "Unexpected max serialisation length");
