...
struct NavRelposned_v1Fields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return
                    cc_ublox::message::NavRelposned_v1FieldsCommon::FlagsMembersCommon::BitsLowCommon::bitName(
        ...
        public:
            ...
            {
                return
                    cc_ublox::message::NavRelposned_v1FieldsCommon::FlagsMembersCommon::BitsHighCommon::bitName(
                        static_cast<std::size_t>(idx));
            }
