...
#include <tuple>
#include "cc_ublox/message/CfgDoscPollCommon.h"
...
/// @see @ref CfgDoscPoll
/// @headerfile cc_ublox/message/CfgDoscPoll.h
...
class CfgDoscPoll : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<1633 /* 0x661 */>,
...
public:
    ...
    {
        return cc_ublox::message::CfgDoscPollCommon::name();
    }
};
