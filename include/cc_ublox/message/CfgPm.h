...
struct CfgPmFields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return
                    cc_ublox::message::CfgPmFieldsCommon::FlagsMembersCommon::BitsMidCommon::bitName(
        ...
        public:
            ...
            {
                return
                    cc_ublox::message::CfgPmFieldsCommon::FlagsMembersCommon::BitsHighCommon::bitName(
                        static_cast<std::size_t>(idx));
            }
