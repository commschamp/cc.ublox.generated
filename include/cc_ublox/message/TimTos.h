...
struct TimTosFields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return cc_ublox::message::TimTosFieldsCommon::FlagsMembersCommon::BitsLowCommon::bitName(idx);
            }
        ...
        class BitsHigh : public
            comms::field::BitmaskValue<
                ...
                comms::option::def::BitmaskReservedBits<0x1FFFF8U, 0x0>
            >
        {
            using Base =
                comms::field::BitmaskValue<
        ...
        public:
            ...
            static const char* bitName(std::size_t idx)
            {
                return cc_ublox::message::TimTosFieldsCommon::FlagsMembersCommon::BitsHighCommon::bitName(idx);
            }
...
class TimTos : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<3346 /* 0xd12 */>,
...
public:
    ...
    static_assert(MsgMinLen == 56, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 56, "Unexpected max serialisation length");
