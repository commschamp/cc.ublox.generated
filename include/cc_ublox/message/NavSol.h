...
struct NavSolFields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::NavSolFieldsCommon::FlagsCommon::bitName(idx);
        }
...
class NavSol : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<262 /* 0x106 */>,
...
public:
    ...
    static_assert(MsgMinLen == 52, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 52, "Unexpected max serialisation length");
