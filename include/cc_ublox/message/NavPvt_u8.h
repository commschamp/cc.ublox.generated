...
struct NavPvt_u8Fields
{
    ...
    class Flags2 : public
        comms::field::BitmaskValue<
            ...
            comms::option::def::HasName,
            comms::option::def::FixedLength<1>,
            comms::option::def::BitmaskReservedBits<0x1F, 0x0>
        >
    {
        using Base =
            comms::field::BitmaskValue<
    ...
    class HeadVeh : public
        comms::field::IntValue<
            ...
            std::int32_t,
            comms::option::def::HasName,
            comms::option::def::ScalingRatio<1, 100000>,
...
class NavPvt_u8 : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<263 /* 0x107 */>,
...
public:
    ...
    static_assert(MsgMinLen == 92, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 92, "Unexpected max serialisation length");
