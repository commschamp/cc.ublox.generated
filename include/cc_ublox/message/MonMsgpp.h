...
class MonMsgpp : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<2566 /* 0xa06 */>,
...
public:
    ...
    static_assert(MsgMinLen == 120, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 120, "Unexpected max serialisation length");
