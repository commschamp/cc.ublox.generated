...
struct RxmPmreqV0Fields
{
    ...
    class Flags : public
        comms::field::BitmaskValue<
            ...
            comms::option::def::BitmaskReservedBits<0xFFFFFFF9U, 0x0>
        >
    {
        using Base =
            comms::field::BitmaskValue<
    ...
    public:
        ...
        {
            return cc_ublox::message::RxmPmreqV0FieldsCommon::FlagsCommon::bitName(idx);
        }
    ...
    class WakeupSources : public
        comms::field::BitmaskValue<
            ...
            comms::option::def::HasName,
            comms::option::def::FixedLength<4>,
            comms::option::def::BitmaskReservedBits<0xFFFFFF17U, 0x0>
        >
    {
        using Base =
            comms::field::BitmaskValue<
    ...
    public:
        ...
        static const char* bitName(std::size_t idx)
        {
            return cc_ublox::message::RxmPmreqV0FieldsCommon::WakeupSourcesCommon::bitName(idx);
        }
