...
struct MonGnssFields
{
    ...
    public:
        ...
        {
            return
                cc_ublox::message::MonGnssFieldsCommon::SupportedCommon::bitName(
    ...
    public:
        ...
        {
            return
                cc_ublox::message::MonGnssFieldsCommon::DefaultGnssCommon::bitName(
                    static_cast<std::size_t>(idx));
        }
    ...
    public:
        ...
        {
            return
                cc_ublox::message::MonGnssFieldsCommon::EnabledCommon::bitName(
                    static_cast<std::size_t>(idx));
        }
