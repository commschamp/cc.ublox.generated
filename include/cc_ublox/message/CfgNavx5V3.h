...
#include "cc_ublox/message/CfgNavx5V3Common.h"
...
/// @see @ref CfgNavx5V3
/// @headerfile cc_ublox/message/CfgNavx5V3.h
...
struct CfgNavx5V3Fields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::VersionCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::VersionCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved1Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::MinSVsCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::MinSVsCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::MaxSVsCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::MaxSVsCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::MinCNOCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::MinCNOCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved2Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::IniFix3DCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::IniFix3DCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved3Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::AckAidingCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::AckAidingCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::WknRolloverCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::WknRolloverCommon::name();
        }
    };

    /// @brief Definition of <b>"sigAttenCompMode"</b> field.
    struct SigAttenCompMode: public
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved4Common::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved5Common::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved6Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::UsePPPCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::UsePPPCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved7Common::name();
        }
    };

    /// @brief Definition of <b>"aopOrbMaxErr"</b> field.
    struct AopOrbMaxErr: public
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved8Common::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved9Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::UseAdrCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::UseAdrCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved10Common::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::CfgNavx5V3FieldsCommon::Reserved11Common::name();
        }
    };
...
class CfgNavx5V3 : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<1571 /* 0x623 */>,
...
public:
    ...
    static_assert(MsgMinLen == 44, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 44, "Unexpected max serialisation length");

    /// @brief Name of the message.
    static const char* doName()
    {
        return cc_ublox::message::CfgNavx5V3Common::name();
    }
};
