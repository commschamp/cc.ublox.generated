...
#include <tuple>
#include "cc_ublox/message/LogEraseCommon.h"
...
/// @see @ref LogErase
/// @headerfile cc_ublox/message/LogErase.h
...
class LogErase : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<8451 /* 0x2103 */>,
...
public:
    ...
    {
        return cc_ublox::message::LogEraseCommon::name();
    }
};
