...
struct NavTimeutcFields
{
    ...
    class Nano : public
        comms::field::IntValue<
            ...
            comms::option::def::HasName,
            comms::option::def::UnitsNanoseconds,
            comms::option::def::ValidNumValueRange<-1000000000, 100000000>
        >
    {
        using Base =
            comms::field::IntValue<
    ...
    struct ValidMembers
    {
        ...
        public:
            ...
            {
                return cc_ublox::message::NavTimeutcFieldsCommon::ValidMembersCommon::BitsCommon::bitName(idx);
            }
...
class NavTimeutc : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<289 /* 0x121 */>,
