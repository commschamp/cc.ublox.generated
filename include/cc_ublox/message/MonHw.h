...
struct MonHwFields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return cc_ublox::message::MonHwFieldsCommon::FlagsMembersCommon::BitsLowCommon::bitName(idx);
            }
        ...
        class BitsHigh : public
            comms::field::BitmaskValue<
                ...
                comms::option::def::BitmaskReservedBits<0xE, 0x0>
            >
        {
            using Base =
                comms::field::BitmaskValue<
        ...
        public:
            ...
            static const char* bitName(std::size_t idx)
            {
                return cc_ublox::message::MonHwFieldsCommon::FlagsMembersCommon::BitsHighCommon::bitName(idx);
            }
    ...
    class VP : public
        comms::field::ArrayList<
            ...
            comms::option::def::HasName,
            comms::option::def::SequenceFixedSize<17>
        >
    {
        using Base =
            comms::field::ArrayList<
...
class MonHw : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<2569 /* 0xa09 */>,
...
public:
    ...
    static_assert(MsgMinLen == 60, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 60, "Unexpected max serialisation length");
