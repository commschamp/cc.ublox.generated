...
#include "cc_ublox/message/MgaBdsIonoCommon.h"
...
/// @see @ref MgaBdsIono
/// @headerfile cc_ublox/message/MgaBdsIono.h
...
struct MgaBdsIonoFields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::TypeCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::TypeCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::VersionCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::VersionCommon::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Reserved1Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Alpha0Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Alpha0Common::name();
        }
    };
    ...
    class Alpha1 : public
        comms::field::IntValue<
            ...
            std::int8_t,
            comms::option::def::HasName,
            comms::option::def::ScalingRatio<1, 134217728>
        >
    {
        using Base =
            comms::field::IntValue<
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Alpha1Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Alpha1Common::name();
        }
    };
    ...
    class Alpha2 : public
        comms::field::IntValue<
            ...
            std::int8_t,
            comms::option::def::HasName,
            comms::option::def::ScalingRatio<1, 16777216>
        >
    {
        using Base =
            comms::field::IntValue<
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Alpha2Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Alpha2Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Alpha3Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Alpha3Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Beta0Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Beta0Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Beta1Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Beta1Common::name();
        }
    };
    ...
    class Beta2 : public
        comms::field::IntValue<
            ...
            std::int8_t,
            comms::option::def::HasName,
            comms::option::def::ScalingRatio<65536, 1>
        >
    {
        using Base =
            comms::field::IntValue<
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Beta2Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Beta2Common::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Beta3Common::hasSpecials();
        }
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Beta3Common::name();
        }
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::MgaBdsIonoFieldsCommon::Reserved2Common::name();
        }
    };
...
public:
    ...
    {
        return cc_ublox::message::MgaBdsIonoCommon::name();
    }
};
