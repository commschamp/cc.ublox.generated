        ...
        struct ElementMembers
        {
            ...
            struct FlagsMembers
            {
                ...
                public:
                    ...
                    {
                        return cc_ublox::message::CfgDoscFieldsCommon::ListMembersCommon::ElementMembersCommon::FlagsMembersCommon::BitsCommon::bitName(idx);
                    }
                ...
                class Reserved : public
                    comms::field::IntValue<
                        ...
                        std::uint16_t,
                        comms::option::def::HasName,
                        comms::option::def::FixedBitLength<11>,
                        comms::option::def::ValidNumValue<0>
                    >
                {
                    using Base =
