...
struct NavSigFieldsCommon
{
    ...
    struct ListMembersCommon
    {
        ...
        struct ElementMembersCommon
        {
            ...
            /// @brief Common types and functions for
            ///     @ref cc_ublox::message::NavSigFields::ListMembers::ElementMembers::Cno field.
            struct CnoCommon
            {
                /// @brief Re-definition of the value type used by
                ///     cc_ublox::message::NavSigFields::ListMembers::ElementMembers::Cno field.
                using ValueType = std::uint8_t;

                /// @brief Name of the @ref cc_ublox::message::NavSigFields::ListMembers::ElementMembers::Cno field.
                static const char* name()
                {
                    return "cno";
                }
