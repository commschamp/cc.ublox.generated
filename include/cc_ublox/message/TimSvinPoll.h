...
#include <tuple>
#include "cc_ublox/message/TimSvinPollCommon.h"
...
/// @see @ref TimSvinPoll
/// @headerfile cc_ublox/message/TimSvinPoll.h
...
class TimSvinPoll : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<3334 /* 0xd06 */>,
...
public:
    ...
    {
        return cc_ublox::message::TimSvinPollCommon::name();
    }
};
