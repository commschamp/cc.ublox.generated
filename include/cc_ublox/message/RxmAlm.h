...
#include "cc_ublox/message/RxmAlmCommon.h"
...
/// @see @ref RxmAlm
/// @headerfile cc_ublox/message/RxmAlm.h
...
struct RxmAlmFields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::RxmAlmFieldsCommon::SvidCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::RxmAlmFieldsCommon::SvidCommon::name();
        }
    };
    ...
    public:
        ...
        static constexpr bool hasSpecials()
        {
            return cc_ublox::message::RxmAlmFieldsCommon::WeekCommon::hasSpecials();
        }

        /// @brief Name of the field.
        static const char* name()
        {
            return cc_ublox::message::RxmAlmFieldsCommon::WeekCommon::name();
        }
    };
    ...
    struct DwrdMembers
    {
        ...
        struct ListMembers
        {
            ...
            public:
                ...
                static constexpr bool hasSpecials()
                {
                    return cc_ublox::message::RxmAlmFieldsCommon::DwrdMembersCommon::ListMembersCommon::ElementCommon::hasSpecials();
                }

                /// @brief Name of the field.
                static const char* name()
                {
                    return cc_ublox::message::RxmAlmFieldsCommon::DwrdMembersCommon::ListMembersCommon::ElementCommon::name();
                }
            };
        };
        ...
        public:
            ...
            static const char* name()
            {
                return cc_ublox::message::RxmAlmFieldsCommon::DwrdMembersCommon::ListCommon::name();
            }
        };
    };
    ...
    public:
        ...
        static const char* name()
        {
            return cc_ublox::message::RxmAlmFieldsCommon::DwrdCommon::name();
        }
    };
...
public:
    ...
    {
        return cc_ublox::message::RxmAlmCommon::name();
    }
...
private:
    ...
    bool refresh_dwrd()
    {
        ...
        if (field_week().getValue() != static_cast<typename Field_week::ValueType>(0)) {
