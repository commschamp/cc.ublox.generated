...
struct NavStatusFields
{
    ...
    public:
        ...
        {
            return cc_ublox::message::NavStatusFieldsCommon::FlagsCommon::bitName(idx);
        }
    ...
    struct FixStatMembers
    {
        ...
        class Bits : public
            comms::field::BitmaskValue<
                ...
                comms::option::def::BitmaskReservedBits<0x3C, 0x0>
            >
        {
            using Base =
                comms::field::BitmaskValue<
        ...
        public:
            ...
            static const char* bitName(std::size_t idx)
            {
                return cc_ublox::message::NavStatusFieldsCommon::FixStatMembersCommon::BitsCommon::bitName(idx);
            }
...
class NavStatus : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<259 /* 0x103 */>,
