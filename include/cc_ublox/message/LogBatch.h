...
class LogBatch : public
    comms::MessageBase<
        ...
        comms::option::def::StaticNumIdImpl<8465 /* 0x2111 */>,
...
public:
    ...
    static_assert(MsgMinLen == 100, "Unexpected min serialisation length");
    static_assert(MsgMaxLen == 100, "Unexpected max serialisation length");
