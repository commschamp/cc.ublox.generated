...
struct LogBatchFields
{
    ...
    public:
        ...
        {
            return
                cc_ublox::message::LogBatchFieldsCommon::ContentValidCommon::bitName(
    ...
    public:
        ...
        {
            return
                cc_ublox::message::LogBatchFieldsCommon::ValidCommon::bitName(
                    static_cast<std::size_t>(idx));
        }
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return
                    cc_ublox::message::LogBatchFieldsCommon::FlagsMembersCommon::BitsLowCommon::bitName(
                        static_cast<std::size_t>(idx));
            }
