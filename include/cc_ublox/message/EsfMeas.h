    ...
    struct FlagsMembers
    {
        ...
        class Bits : public
            comms::field::BitmaskValue<
                ...
                comms::option::def::BitmaskReservedBits<0x3FFC, 0x0>
            >
        {
            using Base =
                comms::field::BitmaskValue<
        ...
        public:
            ...
            {
                return cc_ublox::message::EsfMeasFieldsCommon::FlagsMembersCommon::BitsCommon::bitName(idx);
            }
...
class EsfMeas : public
    comms::MessageBase<
        TMsgBase,
        comms::option::def::StaticNumIdImpl<4098 /* 0x1002 */>,
