...
struct NavRelposnedFields
{
    ...
    struct FlagsMembers
    {
        ...
        public:
            ...
            {
                return
                    cc_ublox::message::NavRelposnedFieldsCommon::FlagsMembersCommon::BitsLowCommon::bitName(
        ...
        public:
            ...
            {
                return
                    cc_ublox::message::NavRelposnedFieldsCommon::FlagsMembersCommon::BitsHighCommon::bitName(
                        static_cast<std::size_t>(idx));
            }
