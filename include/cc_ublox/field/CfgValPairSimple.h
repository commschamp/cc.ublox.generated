...
struct CfgValPairSimpleMembers
{
    ...
    public:
        ...
        using MemberNameInfo = cc_ublox::field::CfgValPairSimpleMembersCommon::ValCommon::MemberNameInfo;

        /// @brief Type returned from @ref memberNamesMap() member function.
        /// @see @ref cc_ublox::field::CfgValPairSimpleMembersCommon::ValCommon::MemberNamesMapInfo.
        using MemberNamesMapInfo = cc_ublox::field::CfgValPairSimpleMembersCommon::ValCommon::MemberNamesMapInfo;
        ...
        /// @see @ref cc_ublox::field::CfgValPairSimpleMembersCommon::ValCommon::memberName().
        static const char* memberName(std::size_t idx)
        {
            return cc_ublox::field::CfgValPairSimpleMembersCommon::ValCommon::memberName(idx);
        }
        ...
        /// @see @ref cc_ublox::field::CfgValPairSimpleMembersCommon::ValCommon::memberNamesMap().
        static MemberNamesMapInfo memberNamesMap()
        {
            return cc_ublox::field::CfgValPairSimpleMembersCommon::ValCommon::memberNamesMap();
        }
