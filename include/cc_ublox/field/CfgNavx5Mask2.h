...
class CfgNavx5Mask2 : public
    comms::field::BitmaskValue<
        ...
        comms::option::def::BitmaskReservedBits<0xFFFFFF3FU, 0x0>
    >
{
    using Base =
        comms::field::BitmaskValue<
...
public:
    ...
    /// @see @ref cc_ublox::field::CfgNavx5Mask2Common::bitName().
    static const char* bitName(std::size_t idx)
    {
        return cc_ublox::field::CfgNavx5Mask2Common::bitName(idx);
    }
    ...
    {
        return cc_ublox::field::CfgNavx5Mask2Common::name();
    }
};
