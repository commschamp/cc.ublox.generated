...
class CfgCfgMask : public
    comms::field::BitmaskValue<
        ...
        comms::option::def::BitmaskReservedBits<0xFFFFE0E0U, 0x0>
    >
{
    using Base =
        comms::field::BitmaskValue<
...
public:
    ...
    /// @see @ref cc_ublox::field::CfgCfgMaskCommon::bitName().
    static const char* bitName(std::size_t idx)
    {
        return cc_ublox::field::CfgCfgMaskCommon::bitName(idx);
    }
    ...
    {
        return cc_ublox::field::CfgCfgMaskCommon::name();
    }
};
